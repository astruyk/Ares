...
if (_activated && local _logic) then
{
	...
	//[[_groupUnderCursor, 50, "NEAREST", getPos _logic, (count (units _groupUnderCursor) <= 3)], "Ares_fnc_JtdSearchBuilding", false] call BIS_fnc_MP;
	[_JtdSearchBuildingBlock, [_groupUnderCursor, 50, "NEAREST", getPos _logic, (count (units _groupUnderCursor) <= 3)], false] call Ares_fnc_BroadcastCode;
