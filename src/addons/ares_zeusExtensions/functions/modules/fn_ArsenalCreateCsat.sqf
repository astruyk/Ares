...
if (_activated && local _logic) then
{
	...
	_data = 
		[
			...
			["hgun_P07_F","hgun_Rook40_F","hgun_ACPC2_F","hgun_Pistol_heavy_01_F","hgun_Pistol_heavy_02_F","MineDetector","arifle_Katiba_F","arifle_Katiba_C_F","arifle_Katiba_GL_F","LMG_Zafir_F","srifle_DMR_01_F","launch_RPG32_F","launch_I_Titan_F","launch_I_Titan_short_F"]
		];
