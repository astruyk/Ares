...
{
	_dialogResult = [["All units in mission", "All units within 50m", "All units within 100m", "All units within 500m"], 0, "Please choose an option:"] call Ares_fnc_GetDialogChoiceFromUser;
